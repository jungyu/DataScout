...
class CaptchaError(DataScoutError):
    ...
    def __init__(self, message: str, code: Optional[int] = None):
        ...
        self.code = code or 5000  # 驗證碼錯誤代碼從 5000 開始
...
class DetectionError(CaptchaError):
    """檢測錯誤類"""
    def __init__(self, message: str, code: int = 5002):
        super().__init__(message, code)
    
class RecognitionError(CaptchaError):
    """識別錯誤類"""
    def __init__(self, message: str, code: int = 5003):
        super().__init__(message, code)
    
class SolverError(CaptchaError):
    """求解錯誤類"""
    def __init__(self, message: str, code: int = 5004):
        super().__init__(message, code)
    
class ValidationError(CaptchaError):
    """驗證錯誤類"""
    def __init__(self, message: str, code: int = 5005):
        super().__init__(message, code)
    
class StateError(CaptchaError):
    """狀態錯誤類"""
    def __init__(self, message: str, code: int = 5006):
        super().__init__(message, code)
