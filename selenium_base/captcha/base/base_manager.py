...
from .base_error import CaptchaError, handle_error, log_error
...
class BaseManager(ABC):
    ...
    def validate_config(self) -> None:
        ...
        if not isinstance(self.config, BaseConfig):
            raise CaptchaError("配置必須是 BaseConfig 類型")
    ...
    def save_config(self, path: str) -> None:
        ...
        try:
            ...
            raise CaptchaError(f"保存配置失敗：{str(e)}")
    ...
    def load_config(self, path: str) -> None:
        ...
        try:
            ...
            raise CaptchaError(f"加載配置失敗：{str(e)}")
    ...
    def add_cdp_command(self, command: str, params: Dict) -> None:
        ...
        try:
            ...
            raise CaptchaError(f"添加 CDP 命令失敗：{str(e)}")
