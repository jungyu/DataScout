...
SELECTORS: Dict[str, Dict[str, str]] = {
    ...
    "product": {
        "list_item": "div.goodsUrl",
        "name": "//h3[@class='prdName']/@title",
        "price": "//div[@class='money']//b/text()",
        "link": "//a[@class='goods-img-url']/@href",
        "image": "//div[@class='swiper-slide swiper-slide-active']//img[@class='prdImg']/@src",
        "promotion": "//p[@class='sloganTitle']/text()",
        "tags": "//div[@class='iconArea']//i",
        "detail_name": "//h3[@class='prdName']/@title",
        "detail_price": "//div[@class='money']//b/text()",
        "description": "div.productText",
        "specs": "div.specificationBox table tr",
        "spec_name": "th",
        "spec_value": "td",
        "images": "div.swiper-wrapper img",
    },
    "pagination": {
