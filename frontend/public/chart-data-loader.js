        ...
        if (loadButton && !loadButton._hasClickListener) {
          ...
          loadButton.addEventListener('click', () => {
            ...
            switch(itemId) {
              // 線圖數據
              case 'sales-data':
                jsonFile = 'assets/examples/apexcharts_line_sales.json';
                break;
              case 'revenue-data':
                jsonFile = 'assets/examples/apexcharts_timeseries_line_unemployment.json';
                break;
              ...
              // 區域圖數據
              case 'webstat-data':
                jsonFile = 'assets/examples/apexcharts_area_webstat.json';
                break;
              case 'traffic-data':
                jsonFile = 'assets/examples/apexcharts_timeseries_area_debt.json';
                break;
              ...
              // 柱狀圖數據
              case 'finance-data':
                jsonFile = 'assets/examples/apexcharts_column_finance.json';
                break;
              case 'product-data':
                jsonFile = 'assets/examples/apexcharts_grouped_bar_sales.json';
                break;
              case 'comparison-data':
                jsonFile = 'assets/examples/apexcharts_stacked_bar_finance.json';
                break;
              
              // 蠟燭圖數據
              case 'apple-data':
                jsonFile = 'assets/examples/apexcharts_candlestick_stock.json';
                break;
              case 'tsmc-data':
                jsonFile = 'assets/examples/apexcharts_candlestick_stock.json';
                break;
